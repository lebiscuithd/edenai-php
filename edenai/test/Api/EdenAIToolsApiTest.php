...
/**
 * EdenAIToolsApiTest Class Doc Comment
 *
 * @category Class
 * @package  edenai
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EdenAIToolsApiTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->words = "['happy','texte','year']"; // string | Provider to compare (ex: [ 'amazon', 'microsoft', 'google'])
        $this->apiInstance = new Api\EdenAIToolsApi(
     ...
     * Search retourner rien a cause du type de retour de l'api search, il n'arrive pas retourner les valeurs trouvé dans result correctement 
     * du coup il retourne rien
     * .
     *
     */
    public function testSearch()
    {
        $result = $this->apiInstance->search($this->text, $this->words);
