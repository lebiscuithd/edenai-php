...
class TranslationApiTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->source_language = "fr-FR"; // string | Language code of text (ex: fr (French), en (English), es (Spanish))
        $this->target_language = "en-US"; // string | Language code of text (ex: fr (French), en (English), es (Spanish))
        $this->providers = "['google']"; // string | Provider to compare (ex: [ 'amazon', 'microsoft', 'google'])
        $this->apiInstance = new Api\TranslationApi(
    ...
    /**
     * Test case for automaticTranslation
     *
     * .
     *
     */
    public function testAutomaticTranslation()
    {
        $result = $this->apiInstance->automaticTranslation($this->text, $this->source_language, $this->target_language, $this->providers);
        $this->assertNotNull($result);
        $this->assertNotNull($result->getResult()[0]['result']);
        $this->assertNotNull($result->getResult()[0]['result']->getSourceLanguage());
        $this->assertNotNull($result->getResult()[0]['result']->getTargetLanguage());
        $this->assertNotNull($result->getResult()[0]['result']->getTranslatedText());
    }

    /**
     * Test case for languageDetection
     *
     * .
     *
     */
    ...
    {
        $result = $this->apiInstance->languageDetection($this->text, $this->providers);
        $this->assertNotNull($result);
        $this->assertNotNull($result->getResult()[0]['result']);
        $this->assertNotNull($result->getResult()[0]['result']->getText());
        $this->assertNotNull($result->getResult()[0]['result']->getLanguages());
