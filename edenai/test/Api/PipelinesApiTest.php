 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PipelinesApiTest extends \PHPUnit_Framework_TestCase
{

    protected $config;
    protected $apiInstance;
    protected $files;
    protected $return_only_last;
    protected $text;
    ...
    public function setUp()
    {
        ...
        $this->files = __DIR__ . "/data/image.jpg"; // \SplFileObject | File Image to analyse (ex: pdf, jpg, jpeg, png, tiff)
        $this->return_only_last = true;
        $this->text = "ceci est un texte";
        // $this->description = "[ { \"feature\": \"ocr\", \"params\": { \"providers\": \"['amazon']\",\"language\": \"en-US\" } }, { \"feature\": \"syntax_analysis\", \"params\": { \"providers\": \"['amazon']\",\"language\": \"en-US\" } }]";
        $this->description = "[ { \"feature\": \"ocr\", \"params\": { \"providers\": \"['amazon']\",\"language\": \"en-US\" } }]";
        $this->apiInstance = new Api\PipelinesApi(
     ...
     *  des erreurs quand on ajoute plusieurs feature, erreur 400 avec text qui est vide alors qu'il ne l'est pas, a voir pourquoi ses erreurs
     * .
     *
     */
    public function testPipelines()
    {
        $result = $this->apiInstance->pipelines($this->description, $this->return_only_last, $this->text, $this->files);
        $this->assertNotNull($result);
        $this->assertNotNull($result->getResult()[0]);
    }
}
