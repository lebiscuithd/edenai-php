 ...
 *
 * @category Class
 * @description syntax analysis response
 * @package  edenai\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2008 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'result' => '\edenai\Client\Model\InlineResponse2008Result1[]'
    ];
     ...
     * Gets result
     *
     * @return \edenai\Client\Model\InlineResponse2008Result1[]
     */
     ...
     * Sets result
     *
     * @param \edenai\Client\Model\InlineResponse2008Result1[] $result result
     *
     * @return $this
     */
