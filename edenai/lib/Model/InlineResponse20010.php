 ...
 *
 * @category Class
 * @description language detection response
 * @package  edenai\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20010 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'result' => '\edenai\Client\Model\InlineResponse20010Result1[]'
    ];
     ...
     * Gets result
     *
     * @return \edenai\Client\Model\InlineResponse20010Result1[]
     */
     ...
     * Sets result
     *
     * @param \edenai\Client\Model\InlineResponse20010Result1[] $result result
     *
     * @return $this
     */
