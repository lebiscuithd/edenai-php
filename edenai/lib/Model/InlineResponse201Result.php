...
/**
 * InlineResponse201Result Class Doc Comment
 *
 * @category Class
 * @description object
 * @package  edenai\Client
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse201Result implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_201_result';
    ...
    {
        $this->container['transcribe'] = isset($data['transcribe']) ? $data['transcribe'] : null;
    ...
    {
        return $this->container['transcribe'];
    }

    /**
     * Sets transcribe
     *
     * @param string $transcribe transcribe
     *
     * @return $this
     */
    public function setTranscribe($transcribe)
    {
        $this->container['transcribe'] = $transcribe;
