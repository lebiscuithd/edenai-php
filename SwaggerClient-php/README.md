...
```
{
  "repositories": [
    {
      "type": "git",
      "url": "https://github.com/edenai/edenai-php//edenai/php-sdk.git"
    }
  ],
  "require": {
    "edenai/php-sdk": "*@dev"
...
*SpeechApi* | [**asynchronousSpeechRecognition**](docs/Api/SpeechApi.md#asynchronousspeechrecognition) | **POST** /pretrained/audio/speech_recognition_async | 
