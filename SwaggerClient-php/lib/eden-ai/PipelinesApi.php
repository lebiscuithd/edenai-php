...
class PipelinesApi
{
     ...
     * @param  bool $return_only_last return_only_last (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\InlineResponse200
     */
    public function pipelines($description, $text, $files, $return_only_last)
    {
        list($response) = $this->pipelinesWithHttpInfo($description, $text, $files, $return_only_last);
        return $response;
    }
     ...
     * @param  bool $return_only_last (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\InlineResponse200, HTTP status code, HTTP response headers (array of strings)
     */
    public function pipelinesWithHttpInfo($description, $text, $files, $return_only_last)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->pipelinesRequest($description, $text, $files, $return_only_last);
     ...
     */
    public function pipelinesAsync($description, $text, $files, $return_only_last)
    {
        return $this->pipelinesAsyncWithHttpInfo($description, $text, $files, $return_only_last)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pipelinesAsyncWithHttpInfo($description, $text, $files, $return_only_last)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->pipelinesRequest($description, $text, $files, $return_only_last);
     ...
     */
    protected function pipelinesRequest($description, $text, $files, $return_only_last)
    {
        ...
        if ($text === null || (is_array($text) && count($text) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $text when calling pipelines'
            );
        }
        // verify the required parameter 'files' is set
        if ($files === null || (is_array($files) && count($files) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $files when calling pipelines'
            );
        }
