...
/**
 * OcrOcrInvoiceBody Class Doc Comment
 *
 * @category Class
 * @package  edenai
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OcrOcrInvoiceBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ocr_ocr_invoice_body';
...
'language' => 'getLanguage'    ];
     ...
     * Sets files
     *
     * @param string $files File Image to analyse (ex: pdf, jpg, jpeg, png)
     *
     * @return $this
     */
