...
/**
 * TranslationAutomaticTranslationBody1 Class Doc Comment
 *
 * @category Class
 * @package  edenai
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TranslationAutomaticTranslationBody1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'translation_automatic_translation_body_1';
...
'providers' => 'getProviders'    ];
     ...
     *
     * @param string $source_language Language code of text (ex: fr (French), en (English), es (Spanish))
     *
     * @return $this
     */
     ...
     *
     * @param string $target_language Language code of text (ex: fr (French), en (English), es (Spanish))
     *
     * @return $this
     */
