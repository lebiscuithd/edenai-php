...
/**
 * VisionObjectDetectionBody Class Doc Comment
 *
 * @category Class
 * @package  edenai
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VisionObjectDetectionBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'vision_object_detection_body';
...
'providers' => 'getProviders'    ];
     ...
     * Sets files
     *
     * @param string $files File Image to analyse (ex: pdf, jpg, jpeg, png, tiff)
     *
     * @return $this
     */
